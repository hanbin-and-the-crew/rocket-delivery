package org.sparta.delivery.infrastructure.kafka.config;
 ...
 * - OrderApprovedEvent 역직렬화를 위한 전용 컨테이너 팩토리
 */
@Configuration
public class DeliveryKafkaConfig {
    ...
    /**
     * Delivery 전용 KafkaListenerContainerFactory
     */
    @Bean
